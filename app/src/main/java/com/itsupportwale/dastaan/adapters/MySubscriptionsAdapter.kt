...
class MySubscriptionsAdapter(activity: Context, arrayList: ArrayList<ResponseMySubscription.Story>) : RecyclerView.Adapter<MySubscriptionsAdapter.ListViewHolder>() {

    var activity: Context
    var arrayList:ArrayList<ResponseMySubscription.Story>
