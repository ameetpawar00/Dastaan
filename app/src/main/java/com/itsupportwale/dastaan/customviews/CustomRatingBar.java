package com.itsupportwale.dastaan.customviews;
...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.filled;
    private int mStarOffResource = R.drawable.empty;
    private int mStarHalfResource = R.drawable.half_star;
